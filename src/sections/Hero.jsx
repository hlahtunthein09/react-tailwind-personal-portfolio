...
import { ArrowRight, ChevronDown, Download, Facebook, Github, Linkedin } from 'lucide-react';
              ...
              <div className='space-y-8'>
                  ...
                  <div className='space-y-4'>
                    ...
                    <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                      Hi, I'm Hla Htun Thein - a web developer specializing in React, Next.js and TypeScript.
